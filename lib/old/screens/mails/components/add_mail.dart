...
import 'package:egs/old/api/mail_api.dart';
...
class _AddMailState extends State<AddMail> {
  ...
  void dispose() {
    ...
    namingController.dispose();
    numberoutController.dispose();
    completionoutController.dispose();
    numberinController.dispose();
    completioninController.dispose();
