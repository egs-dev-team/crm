...
import 'package:egs/old/api/service.dart';
...
class SelectUsersState extends State<SelectUsers> {
  ...
  void initState() {
    super.initState();
    selectedUsers = widget.initialProject?.project_to_user;
    fetchUsers();
  }
  ...
  Future<void> saveProject() async {
    try {
      if (widget.initialProject != null) {
        ...
        widget.initialProject?.project_to_user?.clear();
        widget.initialProject?.project_to_user?.addAll(copiedUsers);
